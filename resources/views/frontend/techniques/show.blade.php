            ...
            <div class="row">
                <div class="col-lg-12 col-12 a-left">
                    <ul class="breadcrumb">
                        ...
                        <li><strong><span>{{$technique['title']}}</span></strong></li>
                    ...
                    <div class="right-content col-xl-8 col-lg-8 col-12">
                        <div class="article-details">
                            <h1 class="article-title"><a
                                    href="">{{$technique['title']}}</a></h1>

                                    <div class="social-media" data-permalink="">
                                        <label style="font-size: 20px;">Chia sẻ: </label>
                                        <a target="_blank"
                                            href="http://www.facebook.com/sharer.php?u={{ url('/techniques', $technique->slug) }}"
                                        ...
                                        <a target="_blank"
                                        href="http://twitter.com/share?url={{ url('/techniques', $technique->slug) }}"
                                ...
                                <div class="item clearfix">
                                    <div class="post-thumb">
                                        <a class="image-blog scale_hover"
                                            href="{{ route('techniques.show',$new->slug) }}"
                                            title="{{$new['title']}}">
                                    ...
                                    <div class="contentright">
                                        <h3><a title="{{$new['title']}}"
                                                href="{{ route('techniques.show',$new->slug) }}">{{$new['title']}}</a>
                                        </h3>
