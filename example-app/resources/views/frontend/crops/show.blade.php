...
<div class="breadcrumb_background"  style="background-image: url({{ Voyager::image(setting('site.breadcrumb')) }})">
    ...
    <div class="title_full">
        <div class="container a-center">
            <p class="title_page">Cây trồng</p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-12 a-left">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="changeurl" href="{{route('crops')}}"><span>Cây trồng</span></a>
                            <span class="mr_lr"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 320 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                    <path
                                        d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z" />
                        ...
                        <li><strong><span>{{$crop['title']}}</span></strong>
                        <li>
            ...
            <div class="container">
                <div class="row">
                                ...
                                <div class="swiper-wrapper" id="lightgallery">
                                    <a class="swiper-slide" data-hash="0"
                                        ...
                                        <img height="540" width="540"
                                            ...
                                            alt="{{$crop['title']}}"
                                            data-image="https://bizweb.dktcdn.net/100/448/970/products/9288725096572122500.jpg?v=1646034550487"
                                    ...
                                    <a class="swiper-slide" data-hash="1"
                                        ...
                                        <img height="540" width="540"
                                            src="{{ Voyager::image($crop->image) }}"
                                            alt="{{$crop['title']}}"
                                            data-image="https://bizweb.dktcdn.net/100/448/970/products/sinhtobocungvangsuathomngonbeo.jpg?v=1646034550487"
                                            class="img-product img-responsive mx-auto d-block swiper-lazy" />
                                    </a>
                                    ...
                                    <a class="swiper-slide" data-hash="2"
                                        ...
                                        <img height="540" width="540"
                                            src="{{ Voyager::image($crop->image) }}"
                                            alt="{{$crop['title']}}"
                                            data-image="https://bizweb.dktcdn.net/100/448/970/products/bodbkvwcopy.jpg?v=1646034550487"
                                            class="img-product img-responsive mx-auto d-block swiper-lazy" />
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="details-pro col-12 col-md-6 col-lg-6 col-xl-6">
                        <h1 class="title-product">{{$crop['title']}}</h1>
                        <div class="inventory_quantity">
                        </div>
                        <form enctype="multipart/form-data" data-cart-form id="add-to-cart-form"
                            action="https://template-big-green.mysapo.net/cart/add" method="post"
                            class="form-inline">
                        ...
                        <div class="product-tab e-tabs not-dqtab">
                            <ul class="tabs tabs-title clearfix">
                                ...
                                <li class="tab-link active" data-tab="#tab-1">
                                    <h3><span>Mô tả cây trồng</span></h3>
                                </li>
                            ...
                            <div class="tab-float">
                                ...
                                <div id="tab-1" class="tab-content active content_extab">
                                    <div class="rte product_getcontent">
                                        ...
                                        <div class="read-more">
                                            <span>Xem thêm <svg aria-hidden="true" focusable="false"
